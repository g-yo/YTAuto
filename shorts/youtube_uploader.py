...
class YouTubeUploader:
    ...
    def get_credentials_from_session(self, request):
        """Retrieve credentials from session using traditional OAuth flow."""
        if 'credentials' in request.session:
            ...
            if credentials.expired and credentials.refresh_token:
                try:
                    ...
                    print("🔄 Refreshed credentials from session")
    ...
    def save_credentials_to_session(self, request, credentials):
        """Save credentials to session using traditional OAuth flow."""
